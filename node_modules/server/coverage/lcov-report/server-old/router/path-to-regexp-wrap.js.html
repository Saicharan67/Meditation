...
&nbsp;
   ...
   * @returns {*}
   */
  function <span class="fstat-no" title="function not covered" >decodeUri(</span>str) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >fu</span>nction(route, config) {</span>
      const res = <span class="cstat-no" title="statement not covered" >reg.exec(route);</span>
      const params = <span class="cstat-no" title="statement not covered" >config || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!res) {</span>
<span class="cstat-no" title="statement not covered" >        return false;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (let i = <span class="cstat-no" title="statement not covered" >1,</span> l = <span class="cstat-no" title="statement not covered" >res.length;</span> i &lt; l; i++) {</span>
<span class="cstat-no" title="statement not covered" >        if (!res[i]) {</span>
<span class="cstat-no" title="statement not covered" >          continue;</span>
        }
<span class="cstat-no" title="statement not covered" >        params[keys[i - 1].name] = decodeUri(res[i]);</span>
      }
&nbsp;
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Fri Jun 12 2020 20:34:19 GMT+0200 (Central European Summer Time)
            </div>
        </div>
