...
<head>
    <title>Code coverage report for path-to-regexp-wrap.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> path-to-regexp-wrap.js</h1>
        <div class='clearfix'>
...
&nbsp;
  const parse = match(route, { decode: decodeURIComponent });
  return route =&gt; parse(route).params;
};
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Fri Jun 12 2020 20:57:16 GMT+0200 (Central European Summer Time)
            </div>
        </div>
